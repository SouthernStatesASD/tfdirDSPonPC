...
void TFDIRV2::testSTC() {
    ...
    string str = "//Node configuration\n"
            "//\n"
            "//Text following // is ignored; Spaces in Set or Sensor names not allowed\n"
            "//\n"
            "//parameters following a line with # denote node parameters\n"
            "//parameters following a line with @ <SET> denote parameters for SET\n"
            "//parameters following a line with ! <SET_SENSOR> denote parameters for SENSOR in SET\n"
            "//DataFromat- Data:###, DataRange:[###, ###], DataName:[CCCC...] \n"
            "\n"
            "// Node Parameters\n"
            "&TopNode\n"
            "60.0, [50, 60], [SysFrequency]   //\n"
            "150.0, [3, 150], [Da] // Distance of Phase A sensor to ground\n"
            "150.0, [3, 150], [Db] // Distance of Phase B sensor to ground\n"
            "150.0, [3, 150], [Dc] //Distance of Phase C sensor to ground\n"
            "150.0, [1, 240],  [Dab] // Distance of Phase A to B in meter\n"
            "150.0, [1, 240],  [Dbc] // Distance of Phase B to C in meter\n"
            "300.0, [1, 440],  [Dca] // Distance of Phase C to A in meter\n"
            "0.150, [0.01, 0.2], [daa] // Sensor/Conductor diameter in meter\n"
            "0.0,  [0.0, 1.0], [PCTfact] // Phase coupling tuning factor\n"
            "1,  [0, 1], [ReportPermFault] 	//\n"
            "1,  [0, 1], [ReportTempFault] 	//\n"
            "1,  [0, 1], [ReportMomentEvent] 	//\n"
            "1,  [0, 1], [AutoSwitchOpen]\n"
            "2,  [0, 4], [NumOfRclsTimes]\n"
            "0.20, [0.01, 30.0], [RclsWaitTime]\n"
            "0.20,  [0.1, 10.0], [HotTime]\n"
            "0.20,  [0.01, 10.0], [DeadTime]\n"
            "0.30, [0.1 1.0], [FaultTime]\n"
            "0.20, [0.05, 2.0], [ReturnTime]\n"
            "-20.0, [-85.0, 85], [MTA] // Max_torque_angle\n"
            "178.0, [120, 180], [TAW], //torque_angle_width\n"
            "115.0, [30.0, 500.0], [RatedVolt]\n"
            "1.0, [0.1, 65.0], [LowVoltLimit]\n"
            "140.0, [70.0, 140.0], [HighVoltLimit]\n"
            "10.0, [0.1, 30.0], [LowAmpLimit]\n"
            "\n"
            "// Frist Set Parameters\n"
            "@First_Set\n"
            "1, [1, 3], [SequenceNum]  // not used yet\n"
            "1, [0, 1], [ServiceFlag]\n"
            "0, [0, 1], [VirtualFlag]\n"
            "0, [0, 3], [SetTypeFlag]	// 0/1 TransLine/TapLine\n"
            "1, [0, 1], [SwitchEnabled]	// 0/1 Operation Disabled/Enabled\n"
            "0.5, [0.1, 2.0], [R0]\n"
            "2.01, [0.1, 20.0], [X0]	\n"
            "0.167, [0.1, 2.0], [R1]\n"
            "0.67, [0.1, 2.0], [X1]\n"
            ...
            "0.5, [0.0, 20.0], [Rs1]\n"
            "3.5, [0.0, 20.0], [Xs1]\n"
            "1.0, [1.0, 1000], [AmpSclFactor]\n"
            "0.0, [-30.0, 30.0], [AmpAngOffset]\n"
            "1.0, [0.2, 3000], [VoltSclFactor]\n"
            "0.0, [-30.0, 30.0], [VoltAngOffset] \n"
            "4.8, [1.0, 100.0], [LineLength] // Piper Gap to Huffman\n"
            "1.3, [1.0, 100.0], [TapSegLength]\n"
            "90.0, [60.0, 100.0], [Zone1Setting]\n"
            "150.0,[100.0, 150.0], [Zone2Setting]\n"
            "1000.0, [50.0, 3000.0], [RatedPhaseAmp]\n"
            "300.0, [10.0, 500.0], [RatedNeutralAmp] // 3I0\n"
            "450.0, [20.0, 3000.0], [PhaseFaultSetting]\n"
            "30.0,[2.0, 1000.0], [NeutralFaultSetting] // 3I0\n"
            "20.0, [5.0, 400.0], [DeltaFaultSetting]\n"
            "1.0, [1.0, 100.0], [PhaseSettingDB]\n"
            "1.0, [1.0, 50.0], [NeutralSettingDB]\n"
            "\n"
            "// Set1 first sensor parameters\n"
            "#Set1_Sensor1\n"
            "1,[1,3],[SequenceNum]	// Internal phase code A\n"
            "1, [0, 1], [UseVT]\n"
            "2, [0, 10], [VTasRef]\n"
            "0, [0, 1], [CTPolarity]\n"
            "A, [A,B,C],[PhaseID] // external/comtrade phase code\n"
            "\n"
            "// Set1 2cd sensor parameters\n"
            "#Set1_Sensor2\n"
            "2, [1, 3], [SequenceNum] // Internal phase code B\n"
            "1, [0, 1], [UseVT]\n"
            "2, [0, 10], [VTasRef]\n"
            "0, [0, 1], [CTPolarity]\n"
            "B, [A,B,C],[PhaseID]   // external/comtrade phase code\n"
            "\n"
            "// Set1 3rd sensor parameters\n"
            "#Set1_Sensor3\n"
            "3, [1, 3], [SequenceNum] // internal phase code C\n"
            "1, [0, 1], [UseVT]\n"
            "1, [0, 10], [VTasRef]\n"
            "0, [0, 1], [CTPolarity]\n"
            "C, [A,B,C],[PhaseID]  // external/comtrade phase code\n"
            "\n"
            "// Set2 Parameters\n"
            "@Second_Set\n"
            "2, [1, 3], [SequenceNum]\n"
            ...
            "1.0, [0.2, 3000], [VoltSclFactor]\n"
            "0.0, [-30.0, 30.0], [VoltAngOffset]\n"
            "2.0, [1.0, 100.0], [LineLength]\n"
            "1.5, [1.0, 100.0], [TapSegLength]\n"
            "90.0, [60.0, 90.0], [Zone1Setting]\n"
            "150.0,[100.0, 150.0], [Zone2Setting]\n"
            "1500.0, [50.0, 5000.0], [RatedPhaseAmp]\n"
            "1000.0, [10.0, 1000.0], [RatedNeutralAmp] // 3I0\n"
            "350.0, [10.0, 3000.0], [PhaseFaultSetting]\n"
            "30.0, [10.0, 1000.0], [NeutralFaultSetting] // 3I0\n"
            "10.0, [10.0, 400.0], [DeltaFaultSetting]\n"
            "1.0, [1.0, 100.0], [PhaseSettingDB]\n"
            "1.0, [1.0, 50.0], [NeutralSettingDB]\n"
            "\n"
            "// Set2 1st sensor parameters\n"
            "#Set2_Sensor1\n"
            "1, [1, 3], [SequenceNum]\n"
            "1, [0, 1], [UseVT]\n"
            "0, [0, 10], [VTasRef]\n"
            ...
            "1, [0, 1], [VirtualFlag]\n"
            "1, [0, 3], [SetTypeFlag]\n"
            "0, [0, 1], [SwitchEnabled]	// 0/1 Operation Disabled/Enabled\n"
            "0.5, [0.1, 2.0], [R0]\n"
            "2.01, [0.1, 20.0], [X0]	\n"
            "0.167, [0.1, 2.0], [R1]\n"
            "0.67, [0.1, 2.0], [X1]\n"
            ...
            "1.0, [1.0, 1000], [AmpSclFactor]\n"
            "0.0, [-30.0, 30.0], [AmpAngOffset]\n"
            "1.0, [1.0, 1000], [VoltSclFactor]\n"
            "0.0, [-30.0, 30.0], [VoltAngOffset]\n"
            "2.0, [1.0, 100.0], [LineLength]\n"
            "1.0, [1.0, 100.0], [TapSegLength]\n"
            "120.0, [60.0, 150.0], [Zone1Setting]\n"
            "120.0,[100.0, 150.0], [Zone2Setting]\n"
            "1000.0, [50.0, 2000.0], [RatedPhaseAmp]\n"
            "300.0, [10.0, 500.0], [RatedNeutralAmp] // 3I0\n"
            "300.0, [100.0, 2000.0], [PhaseFaultSetting]\n"
            "30.0, [10.0, 400.0], [NeutralFaultSetting] // 3I0\n"
            "10.0, [10.0, 400.0], [DeltaFaultSetting]\n"
            "1.0, [1.0, 100.0], [PhaseSettingDB]\n"
            "1.0, [1.0, 50.0], [NeutralSettingDB]\n"
            "\n"
    ...
    char * configContents = new char[str.size() + 1];
    std::copy(str.begin(), str.end(), configContents);
    configContents[str.size()] = '\0';
